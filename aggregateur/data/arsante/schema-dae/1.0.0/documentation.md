...
redirect_from: /arsante/schema-dae/1.0.0/documentation.html
...
- Site web : https://wwww.geodae.sante.gouv.fr
- Version : 1.0.0
...
|com_insee (Code Insee de la commune d'implantation du DAE)|chaîne de caractères|Code Insee de la commune d'implantation du DAE|75056|Valeur optionnelle, Motif : `^\d{5}$`|
