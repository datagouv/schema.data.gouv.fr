---
permalink: /scdl/menus-collectifs/0.7.0/documentation.html
redirect_from: null
...
| [etablissementSiret](#code-siret-de-l'établissement-ou-entreprise-qui-a-produit-le-repas-servi.---propriété-etablissementsiret) | chaîne de caractères  | Non |
...
| [menuTexturePlat](#précision-qualitative-associée-à-la-texture-du-plat---propriété-menutextureplat) | chaîne de caractères  | Oui |
...
> *Description : Permet de préciser le type de public, à l'intérieur d'un type de restaurant, destinataire du menu proposé. Valeur par défaut 'tous' <br/>Ex : None*
- Valeur obligatoire
- Type : chaîne de caractères
