---
permalink: /scdl/plats-menus-collectifs/0.2.0/documentation.html
redirect_from: null
...
| [platNutri-score](#indiquation-de-l'indice-nutritif-du-plat---propriété-platnutri-score) | chaîne de caractères  | Non |
| [platPrix](#coût-de-revient-du-plat---propriété-platprix) | chaîne de caractères  | Non |
...
> *Description : Indique la valeur nutritive du plat en fonction des valeur de l'indicateur nutriscore.<br/>Ex : None*
- Valeur optionnelle
- Type : chaîne de caractères
- Valeurs autorisées : 
    - A
