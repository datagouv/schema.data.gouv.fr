...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <link href="../../dist/css/skiplinks.css" rel="stylesheet">
    ...
    <body class="fr-mb-12w" style="margin:0; padding:0;">
        ...
        <header role="banner" class="fr-header">
                ...
                <div class="fr-container">
                    <div class="fr-header__body-row">
                        <div class="fr-header__brand fr-enlarge-link">
                            <div class="fr-header__brand-top">
                                ...
                                <div class="fr-header__navbar">
                                    <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-601" id="button-602" title="Rechercher">
                                        Rechercher
                                    </button>
                                    <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-604" aria-haspopup="menu" id="button-605" title="Menu">
                                        Menu
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="fr-header__tools">
                            ...
                            <div class="fr-header__search fr-modal" id="modal-601">
                                <div class="fr-container fr-container-lg--fluid">
                                    <button class="fr-link--close fr-link" aria-controls="modal-601">Fermer</button>
                                    <div class="fr-search-bar" id="header-search" role="search">
                                        <label class="fr-label" for="header-search-input">Recherche
                                        </label>
                                        <input class="fr-input" placeholder="Rechercher" type="search" id="header-search-input" name="header-search-input">
                                        <button class="fr-btn" id="header-search" title="Rechercher">
                                            Rechercher
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="fr-header__menu fr-modal" id="modal-604" aria-labelledby="button-605">
                <div class="fr-container">
                    <button class="fr-link--close fr-link" aria-controls="modal-604">Fermer</button>
                    <div class="fr-header__menu-links"></div>
                    <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                        <ul class="fr-nav__list">
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-606">Entrée menu</button>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-607">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-607" tabindex="-1">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <button class="fr-link--close fr-link" aria-controls="mega-menu-607">Fermer</button>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-608" aria-current="true">Entrée menu active</button>
                                <div class="fr-collapse fr-menu" id="menu-608">
                                    <ul class="fr-menu__list">
                                        <li>
                                            <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                        </li>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-609">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-609" tabindex="-1">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <button class="fr-link--close fr-link" aria-controls="mega-menu-609">Fermer</button>
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                                <div class="fr-mega-menu__leader">
                                                    <h4 class="fr-h4 fr-mb-2v">Titre éditorialisé</h4>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-610">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-610" tabindex="-1">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <button class="fr-link--close fr-link" aria-controls="mega-menu-610">Fermer</button>
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-col-lg-3">
                                                <h5 class="fr-mega-menu__category">
                                                    <a class="fr-nav__link" href="#" target="_self">Nom de catégorie</a>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-611">Entrée menu</button>
                                <div class="fr-collapse fr-menu" id="menu-611">
                                    <ul class="fr-menu__list">
                                        <li>
                                            <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                        </li>
        ...
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <h1>Liens d&#39;évitement (skiplinks)</h1>
