...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <link href="../../dist/css/consent.css" rel="stylesheet">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-consent-banner">
                            <p class="fr-h6 fr-mb-3v">À propos des cookies sur nomdusite.fr</p>
                            ...
                            <ul class="fr-consent-banner__buttons fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-sm">
                                ...
                                <li>
                                    <button class="fr-btn fr-btn">
                                        Tout refuser
                                    </button>
                                </li>
                                <li>
                                    <button class="fr-btn fr-btn fr-btn fr-btn--secondary" data-fr-opened="false" aria-controls="fr-consent-modal">
                                        Personnaliser
                                    </button>
                                </li>
                            </ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-807">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-807">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-808">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-808">
...
&lt;/dialog&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-809">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-809">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-content-media fr-content-media--lg">
                            <div class="fr-responsive-vid">
                                <div class="fr-consent-placeholder">
                                    <p class="fr-h6 fr-mb-2v">**Nom du service** est désactivé</p>
                                    <p class="fr-mb-6v">Autorisez le dépôt de cookies pour accèder à cette fonctionnalité.</p>
                                    <button class="fr-btn" title="Autoriser">
                                        Autoriser
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-810">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-810">
