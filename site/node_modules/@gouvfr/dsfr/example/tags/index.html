...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Tags - Design System</title>
        ...
        <link href="../../dist/css/tags.css" rel="stylesheet">
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-679">Extrait de code</button>
                            </h3>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-680">Extrait de code</button>
                            </h3>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-681">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-681">
                                <pre class=" language-html"><code>&lt;a class="fr-tag fr-fi-arrow-right-line fr-tag--icon-right" href="#"&gt;Label tag&lt;/a&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h4>Tag seul cliquable</h4>
                    <div class="fr-mb-6v">
                        <a class="fr-tag" href="#">Label tag</a>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-682">Extrait de code</button>
                            </h3>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-683">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-683">
                                <pre class=" language-html"><code>&lt;a class="fr-tag fr-tag--sm" href="#"&gt;Label tag&lt;/a&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h4>Tag seul non cliquable</h4>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-684">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-684">
                                <pre class=" language-html"><code>&lt;p class="fr-tag"&gt;Label tag&lt;/p&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h4>Tag seul non cliquable SM</h4>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-685">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-685">
                                <pre class=" language-html"><code>&lt;p class="fr-tag fr-tag--sm"&gt;Label tag&lt;/p&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h4>Tag seul désactivé</h4>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-686">Extrait de code</button>
                            </h3>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-687">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-687">
                                <pre class=" language-html"><code>&lt;button class="fr-tag fr-tag--sm" disabled=""&gt;Label tag&lt;/button&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-688">Extrait de code</button>
                            </h3>
...
&lt;/ul&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-689">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-689">
                                <pre class=" language-html"><code>&lt;ul class="fr-tags-group"&gt;
    &lt;li&gt;
        &lt;a class="fr-tag fr-tag--sm" href="#"&gt;Label tag&lt;/a&gt;
    &lt;/li&gt;
...
&lt;/ul&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-690">Extrait de code</button>
                            </h3>
...
&lt;/ul&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-691">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-691">
                                <pre class=" language-html"><code>&lt;ul class="fr-tags-group"&gt;
    &lt;li&gt;
        &lt;p class="fr-tag fr-tag--sm"&gt;Label tag&lt;/p&gt;
    &lt;/li&gt;
