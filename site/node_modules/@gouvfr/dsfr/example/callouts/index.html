...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Mises en avant - Design System</title>
        ...
        <link href="../../dist/css/callouts.css" rel="stylesheet">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-callout">
                            <h4 class="fr-callout__title">Mises en avant</h4>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-748">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-748">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-749">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-749">
                                <pre class=" language-html"><code>&lt;div class="fr-callout"&gt;
    &lt;h4 class="fr-callout__title"&gt;Titre mise en avant&lt;/h4&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-750">Extrait de code</button>
                            </h3>
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-751">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-751">
                                <pre class=" language-html"><code>&lt;div class="fr-callout fr-fi-information-line"&gt;
    &lt;h4 class="fr-callout__title"&gt;Titre mise en avant&lt;/h4&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
    &lt;button class="fr-btn" title="Label bouton"&gt;
        Label bouton
