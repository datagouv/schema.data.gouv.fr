...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <link href="../../dist/css/share.css" rel="stylesheet">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-share">
                            ...
                            <ul class="fr-share__group">
                                <li>
                                    <a class="fr-share__link fr-share__link--facebook" title="Partager sur Facebook - désactivé">Partager sur Facebook</a>
                                </li>
                                <li>
                                    <a class="fr-share__link fr-share__link--twitter" title="Partager sur Twitter - désactivé">Partager sur Twitter</a>
                                </li>
                                <li>
                                    <a class="fr-share__link fr-share__link--linkedin" title="Partager sur LinkedIn - désactivé">Partager sur LinkedIn</a>
                                </li>
                                <li>
                                    <a class="fr-share__link fr-share__link--mail" href="mailto:?subject=[À MODIFIER - objet du mail]&body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]" title="Partager par email" target="_blank">Partager par email</a>
                                </li>
