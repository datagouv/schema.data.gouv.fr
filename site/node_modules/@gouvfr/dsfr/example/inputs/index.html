...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <link href="../../dist/css/inputs.css" rel="stylesheet">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-752">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-752">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-text"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input" type="text" id="text-input-text" name="text-input-text"&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-753">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-753">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-number"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input" pattern="[0-9]*" inputmode="numeric" type="number" id="text-input-number" name="text-input-number"&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-754">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-754">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-search"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input" type="search" id="text-input-search" name="text-input-search"&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-755">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-755">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-tel"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input fr-input--error" aria-describedby="text-input-tel-desc-error" required="" type="tel" id="text-input-tel" name="text-input-tel"&gt;
&lt;p id="text-input-tel-desc-error" class="fr-error-text"&gt;
    Texte d’erreur obligatoire
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-756">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-756">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-mail"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input fr-input--error" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,}$" aria-label="pattern: xxx" aria-describedby="text-input-mail-desc-error" required="" type="mail" id="text-input-mail" name="text-input-mail"&gt;
&lt;p id="text-input-mail-desc-error" class="fr-error-text"&gt;
    Texte d’erreur obligatoire
...
&lt;!-- aria-label mandatory to explain patter --&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-757">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-757">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-date"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input fr-input--error" aria-describedby="text-input-date-desc-error" required="" type="date" id="text-input-date" name="text-input-date"&gt;
&lt;p id="text-input-date-desc-error" class="fr-error-text"&gt;
    Texte d’erreur obligatoire
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-758">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-758">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-calendar"&gt;Label champs de saisie
&lt;/label&gt;
&lt;div class="fr-input-wrap fr-fi-calendar-line"&gt;
    &lt;input class="fr-input" type="date" id="text-input-calendar" name="text-input-calendar"&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-759">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-759">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-760">Extrait de code</button>
                            </h3>
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-761">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-761">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;Label champs de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--addon"&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-762">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-placeholder"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input" placeholder="placeholder" type="text" id="text-input-placeholder" name="text-input-placeholder"&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-763">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-763">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-value"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input" value="value" type="text" id="text-input-value" name="text-input-value"&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-764">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-764">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="text-input-disabled"&gt;Label champs de saisie
&lt;/label&gt;
&lt;input class="fr-input" disabled="" type="text" id="text-input-disabled" name="text-input-disabled"&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-765">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-765">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-766">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-766">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-767">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-767">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-768">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-768">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-769">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-769">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-groups1"&gt;Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-770">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-770">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-groups2"&gt;Label champs de saisie
    &lt;/label&gt;
    &lt;input class="fr-input fr-input--error" aria-describedby="text-input-groups2-desc-error" type="text" id="text-input-groups2" name="text-input-groups2"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-771">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-771">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid"&gt;
    &lt;label class="fr-label" for="text-input-groups3"&gt;Label champs de saisie
    &lt;/label&gt;
    &lt;input class="fr-input fr-input--valid" aria-describedby="text-input-groups3-desc-valid" type="text" id="text-input-groups3" name="text-input-groups3"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-772">Extrait de code</button>
                            </h3>
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-773">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-773">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid"&gt;
    &lt;label class="fr-label" for="text-input-groups5"&gt;Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
