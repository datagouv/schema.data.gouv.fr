...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Liens - Design System</title>
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-99">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-99">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-105">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-105">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-106">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-106">
...
<section class="fr-accordion">
  <h3 class="fr-accordion__title">
    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-107" >Extrait de code</button>
  </h3>
  <div class="fr-collapse" id="snippet-107">
