...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Cases à cocher - Design System</title>
    ...
    <body class="fr-mb-12w" style="margin:0; padding:0;">
        ...
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <h1>Cases à cocher (checkboxes)</h1>
            <p>Les cases à cocher permettent à l’utilisateur de sélectionner une ou plusieurs options dans une liste. Elles sont utilisées pour effectuer des sélections multiples (de 0 à N éléments), ou bien pour permettre un choix binaire, lorsque l’utilisateur peut sélectionner ou désélectionner une seule option.</p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-536">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-536">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-537">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-537">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input type="checkbox" id="checkbox-hint" name="checkbox-hint"&gt;
    &lt;label class="fr-label" for="checkbox-hint"&gt;Label checkbox
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-538">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-538">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-539">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-539">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-540">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-540">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-541">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-541">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-small-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-542">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-542">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset" disabled="disabled"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-disabled-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-543">Extrait de code</button>
                            </h3>
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-544">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-544">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-545">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-545">
                                <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkboxes-error-legend checkboxes-error-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-error-legend'&gt;
            Légende pour l’ensemble de champs
