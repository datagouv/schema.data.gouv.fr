...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Listes déroulantes - Design System</title>
        ...
        <link href="../../dist/css/selects.css" rel="stylesheet">
    ...
    <body class="fr-mb-12w" style="margin:0; padding:0;">
        ...
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <h1>Listes déroulantes (selects)</h1>
        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <label class="fr-label" for="select">Label pour liste déroulante
                        </label>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-593">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="select"&gt;Label pour liste déroulante
&lt;/label&gt;
&lt;select class="fr-select" id="select" name="select"&gt;
    &lt;option value="" selected disabled hidden&gt;Selectionnez une option&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
...
&lt;/select&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-594">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-594">
                                <pre class=" language-html"><code>&lt;label class="fr-label" for="select-disabled"&gt;Label pour liste déroulante
&lt;/label&gt;
&lt;select class="fr-select" disabled="" id="select-disabled" name="select-disabled"&gt;
    &lt;option value="" selected disabled hidden&gt;Selectionnez une option&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
...
&lt;/select&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-595">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-595">
