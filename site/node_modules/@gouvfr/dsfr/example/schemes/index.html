...
<html lang="fr" data-fr-theme>
    ...
    <body class="fr-mb-12w" style="margin:0; padding:0;">
        ...
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <h1>Combinaison de couleur (schemes)</h1>
            <p>Les color schemes permettent la définition de couleurs principales et du darkmode pour le Design System de l'Etat.</p>
        </div>
        <header role="banner" class="fr-header">
                        ...
                        <div class="fr-header__brand fr-enlarge-link">
                            <div class="fr-header__brand-top">
                                ...
                                <div class="fr-header__navbar">
                                    <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-117" aria-haspopup="menu" id="button-118" title="Menu">
                                        Menu
                                    </button>
                                </div>
                            </div>
            ...
            <div class="fr-header__menu fr-modal" id="modal-117" aria-labelledby="button-118">
                <div class="fr-container">
                    <button class="fr-link--close fr-link" aria-controls="modal-117">Fermer</button>
                    <div class="fr-header__menu-links"></div>
                    <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                        <ul class="fr-nav__list">
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-119">Entrée menu</button>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-120">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-120" tabindex="-1">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <button class="fr-link--close fr-link" aria-controls="mega-menu-120">Fermer</button>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-121" aria-current="true">Entrée menu active</button>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-122">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-122" tabindex="-1">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <button class="fr-link--close fr-link" aria-controls="mega-menu-122">Fermer</button>
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                                <div class="fr-mega-menu__leader">
                                                    <h4 class="fr-h4 fr-mb-2v">Titre éditorialisé</h4>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-123">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-123" tabindex="-1">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <button class="fr-link--close fr-link" aria-controls="mega-menu-123">Fermer</button>
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-col-lg-3">
                                                <h5 class="fr-mega-menu__category">
                                                    <a class="fr-nav__link" href="#" target="_self">Nom de catégorie</a>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-124">Entrée menu</button>
                                <div class="fr-collapse fr-menu" id="menu-124">
                                    <ul class="fr-menu__list">
                                        <li>
                                            <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                        </li>
        ...
        <div class="fr-container fr-mt-8v">
            <h1>Schemes - gestion du dark mode</h1>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-125">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-125">
                        <pre class=" language-html"><code>&lt;button class="fr-link fr-fi-theme-fill fr-link--icon-left" aria-controls="fr-theme-modal" data-fr-opened="false"&gt;Paramètres d'affichage&lt;/button&gt;
</code></pre>
                    </div>
                </section>
            </div>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-126">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-126">
...
&lt;/dialog&gt;
        ...
        <footer class="fr-footer" role="contentinfo" id="schemes">
            <div class="fr-container">
        ...
        <script type="module" src="../../dist/js/modal.module.js"></script>
        <script type="text/javascript" nomodule src="../../dist/js/modal.nomodule.js"></script>
        ...
        <script type="module" src="../../dist/js/header.module.js"></script>
        <script type="text/javascript" nomodule src="../../dist/js/header.nomodule.js"></script>
        <script>
