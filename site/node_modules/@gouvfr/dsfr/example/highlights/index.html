...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <link href="../../dist/css/highlights.css" rel="stylesheet">
    ...
    <body class="fr-mb-12w" style="margin:0; padding:0;">
        ...
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <h1>Mises en exergue (highlights)</h1>
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-97">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-97">
                                <pre class=" language-html"><code>&lt;div class="fr-highlight"&gt;
    &lt;p class="fr-text--sm"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
