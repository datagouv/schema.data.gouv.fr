                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-108">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-108">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-109">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-109">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-110">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-110">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-111">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-111">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de la transition
    &lt;br&gt;écologique
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-112">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-112">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Secrétaire d’État
    &lt;br&gt;chargé(e) de
    &lt;br&gt;l’égalité entre les
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-113">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-113">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de l’europe
    &lt;br&gt;et des affaires
