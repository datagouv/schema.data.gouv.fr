...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Citations - Design System</title>
        ...
        <link href="../../dist/css/quotes.css" rel="stylesheet">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-114">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-114">
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-115">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-115">
                                <pre class=" language-html"><code>&lt;figure class="fr-quote"&gt;
    &lt;blockquote cite="[À MODIFIER - https://lien-vers-la-source.fr]"&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-116">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-116">
