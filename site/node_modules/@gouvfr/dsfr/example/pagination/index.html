...
&lt;/nav&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-570">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-570">
                        <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--prev fr-pagination__link--label" href="#"&gt;
...
&lt;/nav&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-571">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-571">
                        <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--prev fr-pagination__link--lg-label" href="#"&gt;
...
&lt;/nav&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-573">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-573">
                        <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--first" href="#"&gt;
...
&lt;/nav&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-574">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-574">
                        <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--first" href="#"&gt;
