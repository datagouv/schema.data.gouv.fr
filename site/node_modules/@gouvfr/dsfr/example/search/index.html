        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar" id="search-817" role="search">
                            <label class="fr-label" for="search-817-input">Recherche
                            </label>
                            <input class="fr-input" placeholder="Rechercher" type="search" id="search-817-input" name="search-817-input">
                            <button class="fr-btn" id="search-817" title="Rechercher">
                                Rechercher
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-819">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-819">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar" id="search-818" role="search"&gt;
    &lt;label class="fr-label" for="search-818-input"&gt;Recherche
    &lt;/label&gt;
    &lt;input class="fr-input" placeholder="Rechercher" type="search" id="search-818-input" name="search-818-input"&gt;
    &lt;button class="fr-btn" id="search-818" title="Rechercher"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar fr-search-bar--lg" id="search-820" role="search">
                            <label class="fr-label" for="search-820-input">Recherche
                            </label>
                            <input class="fr-input" placeholder="Rechercher" type="search" id="search-820-input" name="search-820-input">
                            <button class="fr-btn" id="search-820">
                                Rechercher
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-822">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-822">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar fr-search-bar--lg" id="search-821" role="search"&gt;
    &lt;label class="fr-label" for="search-821-input"&gt;Recherche
    &lt;/label&gt;
    &lt;input class="fr-input" placeholder="Rechercher" type="search" id="search-821-input" name="search-821-input"&gt;
    &lt;button class="fr-btn" id="search-821"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
