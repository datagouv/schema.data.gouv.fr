...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Alertes - Design System</title>
        ...
        <link href="../../dist/css/alerts.css" rel="stylesheet">
    ...
    <body class="fr-mb-12w" style="margin:0; padding:0;">
        ...
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <h1>Alertes (alerts)</h1>
            <p>Les alertes permettent d’attirer l’attention de l’utilisateur sur une information sans interrompre sa tâche.</p>
        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <p>Préciser le type d'alerte (Information/Succès/Erreur) dans le titre ou, à défaut, dans le contenu de l'alerte
                        <br>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-489">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-489">
                                <pre class=" language-html"><code>&lt;div role="alert" class="fr-alert"&gt;
    &lt;p class="fr-alert__title"&gt;Alertes&lt;/p&gt;
    &lt;p&gt;Description&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-490">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-490">
                                <pre class=" language-html"><code>&lt;div role="alert" class="fr-alert fr-alert--info"&gt;
    &lt;p class="fr-alert__title"&gt;Information Covid&lt;/p&gt;
    &lt;p&gt;Description&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-491">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-491">
                                <pre class=" language-html"><code>&lt;div role="alert" class="fr-alert fr-alert--success"&gt;
    &lt;p class="fr-alert__title"&gt;Succès de l&amp;#39;envoi&lt;/p&gt;
    &lt;p&gt;Description&lt;/p&gt;
&lt;/div&gt;
</code></pre>
...
<section class="fr-accordion">
  <h3 class="fr-accordion__title">
    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-493" >Extrait de code</button>
  </h3>
  <div class="fr-collapse" id="snippet-493">
    
      <pre class=" language-html"><code>&lt;div role="alert" class="fr-alert fr-alert--warning"&gt;
    &lt;p class="fr-alert__title"&gt;Attention&lt;/p&gt;
    &lt;p&gt;Description&lt;/p&gt;
&lt;/div&gt;
</code></pre>
 ...
 -->
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-494">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-494">
                                <pre class=" language-html"><code>&lt;div role="alert" class="fr-alert fr-alert--info"&gt;
    &lt;p class="fr-alert__title"&gt;Information Covid&lt;/p&gt;
    &lt;p&gt;Description&lt;/p&gt;
    &lt;button class="fr-link--close fr-link" title="Masquer le message"&gt;Masquer le message&lt;/button&gt;
&lt;/div&gt;
                    ...
                    <h4>Alerte refermable (dans un collapse)</h4>
                    <div class="fr-mb-6v">
                        <div class="fr-collapse" id="alert-495">
                            <div role="alert" class="fr-alert fr-alert--info">
                                <p class="fr-alert__title">Information Covid</p>
                                <p>Cliquer sur la croix pour fermer l&#39;alerte</p>
                                <button class="fr-link--close fr-link" title="Masquer le message" aria-expanded="true" aria-controls="alert-495">Masquer le message</button>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-497">
                                <pre class=" language-html"><code>&lt;div class="fr-collapse" id="alert-496"&gt;
    &lt;div role="alert" class="fr-alert fr-alert--info"&gt;
        &lt;p class="fr-alert__title"&gt;Information Covid&lt;/p&gt;
        &lt;p&gt;Cliquer sur la croix pour fermer l&amp;#39;alerte&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-498">
                                <pre class=" language-html"><code>&lt;div role="alert" class="fr-alert fr-alert--info fr-alert--sm"&gt;
    &lt;p&gt;Information : titre de l&amp;#39;information&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-collapse" id="alert-499">
                            <div role="alert" class="fr-alert fr-alert--info fr-alert--sm">
                                <p>Information : cliquer sur la croix pour fermer l&#39;alerte</p>
                                <button class="fr-link--close fr-link" title="Masquer le message" aria-expanded="true" aria-controls="alert-499">Masquer le message</button>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-501">
                                <pre class=" language-html"><code>&lt;div class="fr-collapse" id="alert-500"&gt;
    &lt;div role="alert" class="fr-alert fr-alert--info fr-alert--sm"&gt;
        &lt;p&gt;Information : cliquer sur la croix pour fermer l&amp;#39;alerte&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-502">
                                <pre class=" language-html"><code>&lt;div role="alert" class="fr-fi-lock-fill fr-alert"&gt;
    &lt;p class="fr-alert__title"&gt;Alertes&lt;/p&gt;
    &lt;p&gt;Description&lt;/p&gt;
&lt;/div&gt;
</code></pre>
