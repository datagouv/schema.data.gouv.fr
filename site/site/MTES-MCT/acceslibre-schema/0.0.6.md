...
Une description détaillée (champ par champ) du modèle de donnée est accessible ici : [https://schema.data.gouv.fr/MTES-MCT/acceslibre-schema/0.0.6/documentation.html](https://schema.data.gouv.fr/MTES-MCT/acceslibre-schema/0.0.6/documentation.html). Ce schéma
