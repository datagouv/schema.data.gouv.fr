...
| [long_coor1](#longitude-propriete-long-coor1) | nombre réel  | Oui |
...
| [acc_lib](#acces-libre-du-dae-propriete-acc-lib) | booléen  | Oui |
| [acc_pcsec](#poste-de-securite-propriete-acc-pcsec) | booléen  | Non |
| [acc_acc](#presence-d-un-accueil-public-propriete-acc-acc) | booléen  | Non |
| [dae_mobile](#dae-mobile-propriete-dae-mobile) | booléen  | Non |
...
| [dispo_horaires](#horaires-de-disponibilite-du-dae-propriete-dispo-horaires) | chaîne de caractères  | Oui |
...
#### Longitude - Propriété `long_coor1`
...
#### Accès libre du DAE - Propriété `acc_lib`

> *Description : Accès libre du DAE*<br/>*Exemple : oui*
- Valeur obligatoire
- Type : booléen

#### Poste de sécurité - Propriété `acc_pcsec`

> *Description : Poste de sécurité*<br/>*Exemple : oui*
- Valeur optionnelle
- Type : booléen

#### Présence d'un accueil public - Propriété `acc_acc`

> *Description : Présence d'un accueil public*<br/>*Exemple : oui*
- Valeur optionnelle
- Type : booléen

#### DAE mobile - Propriété `dae_mobile`

> *Description : Il s'agit de préciser si le DAE est à un endroit fixe ou s'il est mobile pour l'accessibilité.*<br/>*Exemple : non*
- Valeur optionnelle
- Type : booléen
...
> *Description : *<br/>*Exemple : 130016538*
- Valeur obligatoire
- Type : chaîne de caractères
...
#### Horaires de disponibilité du DAE - Propriété `dispo_horaires`

> *Description : Horaires de disponibilité du DAE formatés selon le standard OpenStreetMap opening_hours (https://wiki.openstreetmap.org/wiki/Key:opening_hours)*<br/>*Exemple : Mo-Fr 08:00-18:00; Sa 09:00-12:00*
- Valeur obligatoire
- Type : chaîne de caractères
- Motif : `^(?:OFF|24/7|PH (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|(?:Mo|Tu|We|Th|Fr|Sa|Su)(?:-(?:Mo|Tu|We|Th|Fr|Sa|Su))? (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?:[12][0-9]|3[01]|0?[1-9])-(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?:[12][0-9]|3[01]|0?[1-9]) (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?:[12][0-9]|3[01]|0?[1-9]) (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|off)(?:; ?(?:OFF|24/7|PH (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|(?:Mo|Tu|We|Th|Fr|Sa|Su)(?:-(?:Mo|Tu|We|Th|Fr|Sa|Su))? (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?:[12][0-9]|3[01]|0?[1-9])-(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?:[12][0-9]|3[01]|0?[1-9]) (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?:[12][0-9]|3[01]|0?[1-9]) (?:(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9],(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|(?:[01][0-9]|2[0-3]):[0-5][0-9]-(?:[01][0-9]|2[0-3]):[0-5][0-9]|off)|off))*$`
