...
## Schéma d’accessibilité aux établissements recevant du public (ERP) - Bâtiments d'hébergement
...
Le schéma pour les bâtiments d'hébergement est disponible en format [json](https://github.com/MTES-MCT/acceslibre-schema/blob/master/hebergement/schema.json) ou [excel](https://github.com/MTES-MCT/acceslibre-schema/blob/master/hebergement/schema.xls) (à télécharger). (voir procédure avant dépôt des données)
