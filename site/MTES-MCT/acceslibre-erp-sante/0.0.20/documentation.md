...
## acceslibre-erp-sante

Accessibilité ERP — Santé
...
| [accueil_soignant](#soignant-sensibilise-ou-forme-propriete-accueil-soignant) | booléen  | Non |
| [accueil_soignant_experience](#experience-du-soignant-concernant-les-types-de-handicap-propriete-accueil-soignant-experience) | liste  | Non |
| [accueil_salle_consultation_accessible](#accessibilite-de-la-salle-de-consultation-propriete-accueil-salle-consultation-accessible) | booléen  | Non |
| [accueil_consultation_domicile](#consultation-a-domicile-propriete-accueil-consultation-domicile) | booléen  | Non |
| [accueil_prise_en_charge_patients](#prise-en-charge-des-patients-propriete-accueil-prise-en-charge-patients) | liste  | Non |
...
#### Soignant sensibilisé ou formé - Propriété `accueil_soignant`

> *Description : Le soignant est-il formé ou possède-t-il une expérience particulière pour la prise en charge de personnes en situation de handicap*<br/>*Exemple : True*
- Valeur optionnelle
- Type : booléen

#### Expérience du soignant concernant les types de handicap - Propriété `accueil_soignant_experience`

> *Description : Pour quels types de handicap le soignant possède-t-il une expérience particulière. Valeurs possibles: visuel, auditif, moteur, mental, psychique, cognitif*<br/>*Exemple : ["visuel", "auditif", "moteur", "mental", "psychique", "cognitif"]*
- Valeur optionnelle
- Type : liste

#### Accessibilité de la salle de consultation - Propriété `accueil_salle_consultation_accessible`

> *Description : La salle de consultation est-elle accessible en fauteuil roulant ?*<br/>*Exemple : True*
- Valeur optionnelle
- Type : booléen

#### Consultation à domicile - Propriété `accueil_consultation_domicile`

> *Description : Des consultations à domicile sont-elles possibles pour les personnes en situation de handicap ?*<br/>*Exemple : True*
- Valeur optionnelle
- Type : booléen

#### Prise en charge des patients - Propriété `accueil_prise_en_charge_patients`

> *Description : L'établissement offre-t-il des prestations complémentaires pour la prise en charge des patients en situation de handicap ? Valeurs possibles: preparation -> Préparation à la consultation ou visite préalable pour les personnes ayant un handicap mental ou psychique, organisation -> Organisation spécifique pour réduire le temps d’attente pour les personnes ayant un handicap mental ou psychique, outils_communication -> Outils de communication simplifiés pour expliquer les actes, materiel_auscultation -> Matériel d’auscultation adaptés aux personnes obèses*<br/>*Exemple : ["preparation", "organisation", "outils_communication", "materiel_auscultation"]*
- Valeur optionnelle
- Type : liste
