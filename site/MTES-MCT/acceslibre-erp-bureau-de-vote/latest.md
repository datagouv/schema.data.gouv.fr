...
## Schéma d’accessibilité aux établissements recevant du public (ERP) - Bureaux de vote
...
Le schéma pour les bureaux de vote est disponible en format [json](https://github.com/MTES-MCT/acceslibre-schema/blob/master/bureau_de_vote/schema.json) ou [excel](https://github.com/MTES-MCT/acceslibre-schema/blob/master/bureau_de_vote/schema.xls) (à télécharger). (voir procédure avant dépôt des données)
