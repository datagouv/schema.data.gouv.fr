...
## Schéma d’accessibilité aux établissements recevant du public (ERP) - Établissements scolaires
...
Le schéma pour les établissements scolaires est disponible en format [json](https://github.com/MTES-MCT/acceslibre-schema/blob/master/etablissements_scolaires/schema.json) ou [excel](https://github.com/MTES-MCT/acceslibre-schema/blob/master/etablissements_scolaires/schema.xls) (à télécharger). (voir procédure avant dépôt des données)
