...
## Schéma d’accessibilité aux établissements recevant du public (ERP) - Base
...
Les différents schéma sont disponibles en format json ou excel (à télécharger). (voir procédure avant dépôt des données)
