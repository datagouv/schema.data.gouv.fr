...
## Schéma d’accessibilité aux établissements recevant du public (ERP) - Grands établissements
...
Le schéma pour les grands établissements est disponible en format [json](https://github.com/MTES-MCT/acceslibre-schema/blob/master/grands_etablissements/schema.json) ou [excel](https://github.com/MTES-MCT/acceslibre-schema/blob/master/grands_etablissements/schema.xls) (à télécharger). (voir procédure avant dépôt des données)
