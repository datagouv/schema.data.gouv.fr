...
| [urba_zaer](#situation-en-zone-d-acceleration-des-energies-renouvelables-propriete-urba-zaer) | chaîne de caractères  | Oui |
...
> *Description : URL(s) des fiches du site dans BASIAS et/ou dans BASOL ou SIS et/ou dans un observatoire local, lorsqu'elles existent (si plusieurs URL, les séparer avec des '|')*<br/>*Exemple : http://fiches-risques.brgm.fr/georisques/basias-detaillee/AQI4008059*
- Valeur optionnelle
- Type : chaîne de caractères
...
#### situation en zone d'accélération des énergies renouvelables - Propriété `urba_zaer`

> *Description : le site est situé (oui / non) en zone d'accélération des énergies renouvelables*<br/>*Exemple : non*
- Valeur obligatoire
- Type : chaîne de caractères
- Valeurs autorisées : 
    - `oui`
