...
> *Description : Numéro SIREN du/des porteur(s) de l'aide. S'il y a plusieurs porteurs, mettre une virgule sans espace entre les différents porteurs.<br/>Ex : Conseil départemental de la Nièvre,ADEME*
- Valeur obligatoire
- Type : chaîne de caractères
- Motif : `^(?:[^,]{9},)*[^,]{9}$`
...
> *Description : Date de cloture de l'aide. Format YYYY-MM-DD (Année-Mois-Jour)<br/>Ex : 2022-03-03*
- Valeur obligatoire
- Type : date (format `%Y-%m-%d`)
