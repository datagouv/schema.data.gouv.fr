...
> *Description : Code INSEE de la commune où se trouve le stationnement vélo*<br/>*Exemple : 67023*
- Valeur optionnelle
- Type : chaîne de caractères
...
> *Description : La latitude et la longitude en degrés décimaux (point comme séparateur décimal) de la localisation du centre de l'emplacement de stationnement exprimée dans le système de coordonnées WGS84 [lon,lat].*<br/>*Exemple : [7.48710500,48.345345]*
- Valeur obligatoire
