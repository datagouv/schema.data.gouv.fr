...
> *Description : Identifiant du lieu de covoiturage, délivré par le point d'accès national*<br/>*Exemple : 35238-C-001*
- Valeur obligatoire
...
> *Description : Date de dernière mise à jour des données. Notation ISO 8601*<br/>*Exemple : 2016-10-31*
- Valeur obligatoire
...
> *Description : Entité ayant fourni la donnée - sous format SIREN*<br/>*Exemple : 225300011*
- Valeur obligatoire
- Type : chaîne de caractères
- Motif : `^\d{9}$`
...
> *Description : Si il existe une restriction sur la durée de stationnement autorisée, la durée maximale de stationnement autorisée exprimée en minutes.*<br/>*Exemple : 60*
- Valeur optionnelle
- Type : nombre entier
