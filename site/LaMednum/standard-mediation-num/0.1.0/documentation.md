...
> *Description : Ce champ indique si le lieu a obtenu un ou plusieurs labels nationaux. Sélectionner une ou plusieurs valeurs séparées par un point-virgule sans espace parmi la liste suivante : France Services ; CNFS ; APTIC ; Aidants Connect ; Fabriques de Territoire ; Grandes écoles du numérique ; Point relais CAF ; Relais pôle emploi ; French Tech ; Campus connecté<br/>Ex : France Services;APTIC;Point relais CAF*
- Valeur optionnelle
- Type : chaîne de caractères
